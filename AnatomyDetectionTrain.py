...
parser.add_argument('--dataset', default='AnatomyDetection',
                    type=str, help='AnatomyDetection')
parser.add_argument('--dataset_root', default='./dataset/AnatomyDetection/',
...
def train():
    ...
    ssd_net = build_ssd('train', 300, cfg['num_classes'])
    net = ssd_net
    ...
    if args.visdom:
        vis_title = 'SSD.PyTorch on ' + 'Gastric Anatomy Detection'
    ...
    for iteration in range(args.start_iter, cfg['max_iter']):
        ...
        if args.visdom and iteration != 0 and (iteration % epoch_size == 0):
            # update_vis_plot(epoch, loc_loss, conf_loss, epoch_plot, epoch_plot,
            #                 'append', epoch_size)
        ...
        if iteration != 0 and iteration % 5000 == 0:
            ...
            torch.save(ssd_net.state_dict(), 'AnatomyDetection/woloss_ssd300_anatomy_' +
                       repr(iteration) + '.pth')
    torch.save(ssd_net.state_dict(), 'AnatomyDetection/woloss_ssd300_anatomy_' +
               repr(iteration) + '.pth')
